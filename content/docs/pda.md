...
- Transition labels in `input, pop → push` format
...
- **Active Configs** — Each row shows: state name, input position, and current stack contents in `[brackets]`
- **Input Tape** — Visual tape with highlighting for consumed/current positions
